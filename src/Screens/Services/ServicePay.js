...
function ServicesPay({ onBack, data }) {
    ...
    const validationsRules = {
        ...
        telefono: {
            ...
            pattern: {
                value: /^\d{10}$/,
                message: 'Télefono debe de ser de 10 dígitos.'
            }
        },
        email: {
            required: true,
    ...
    const handleSumbit = (e) => {
        ...
        if (Object.keys(validationError).length === 0) {
            //console.log('Formulario valido, enviar datos...', formValue.email);
                    ...
                    <div className='row g-0'>
                        ...
                        <div className='col-md-6 background-muted '>
                            ...
                            <div className='d-flex justify-content-center align-items-center'>
                                <button type='submit' onClick={handleSumbit} className='btn mt-2 text-white bg-primary'>
