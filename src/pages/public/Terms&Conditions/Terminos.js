                ...
                <div className='text-lg justify-stretch text-justify space-x-4'>
                    <div>
                        <p>
                            ...
                            <ul>
                                <li>
                                    Los usuarios solo pueden acceder y utilizar el contenido disponible en el sitio web de acuerdo con los Términos de Uso y la Política de Privacidad.
                            ...
                            <ul>
                                <li>
                                    Debe <b>tener al menos 18 años de edad</b> para convertirse en un usuario registrado de nuestro sitio. Queda estrictamente prohibido el registro de menores de edad sin la autorización y supervisión
                                    de sus padres o tutores.
                                </li>
                                <li>
                                    Al registrarse en nuestro sitio web, tendra que <b>hacer uso de su correo electrónico y una contraseña</b> y será el responsable de asegurar que su cuenta, correo electronico y contraseña, <b>permanezcan confidenciales,
                                        actuales, completos y precisos</b>.
                                </li>
                                <li>
                                    Es responsable de todas las actividades que se producen en su cuenta, correo electrónico y/o contraseña.
                                </li>
                                <li>
                                    Puede almacenar su información de tarjetas bancarias como parte de su cuenta para permitir procesos de cierre de sesión más rápidos.
                                    La recopilación y manejo de esta información se rige por nuestra Política de Privacidad.
                                </li>
                                <li>
                            ...
                            <ul>
                                <li>
                                    Los productos en nuestro sitio web estan sujetos a disponibilidad.
                                </li>
                                <li>
                                    Los productos mostrados en nuestro sitio web se pueden ordenar y entregar sólo dentro de la ciudad de <b>Huejutla de Reyes, Hidalgo, México</b>.
                                </li>
                                <li>
                                    Todos los productos deben utilizarse estrictamente de acuerdo con sus instrucciones, precauciones y siempre se deben de comprobar los ingredientes
                                ...
                                <li>
                                    ...
                                    o no la última presentación del producto. No obstante, el producto es el mismo.
                                </li>
                                <li>
                                    Los colores y las imágenes de nuestros productos se muestran con la mayor precisión posible, no obstante, no podemos garantizar
                            ...
                            <ul>
                                <li>
                                    Nos esforzamos por mostrar con precisión los servicios que ofrecemos, pero no podemos garantizar la exactitud de la representación visual,
                            ...
                            <ul>
                                <li>
                                    Todos los precios para los productos y servicios estan indicados en pesos mexicanos (MXN) e incluyen el Impuesto al Valor Agregado (IVA) correspondiente, y
                                    estarán expresados en MXN.
                                </li>
                                <li>
                                    Los precios de nuestros productos y servicios estan sujetos a cambios sin previo aviso.
                                </li>
                                <li>
