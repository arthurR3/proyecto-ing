                ...
                <div className='text-lg justify-stretch text-justify space-x-4'>
                    ...
                    <section className='mt-3'>
                        ...
                        <ul>
                            ...
                            <li>Prestación de nuestros servicios</li>
                            <li>Mejora de nuestro servicio y/o ofertas</li>
                        </ul>
                        <p>
                        ...
                        <div className="form-check">
                            <input className="form-check-input" type="checkbox" id="userTrackingCheckbox" />
                            <label className="form-check-label" htmlFor="userTrackingCheckbox">
                    ...
                    <section className='mt-3'>
                        ...
                        <ul>
                            ...
                            <li>La transferencia de información se realiza por medios seguros utilizando certificados SSL/TLS en el sitio web.</li>
                            <li>Autenticación de doble factor: . Esta medida adicional de seguridad requiere que los usuarios verifiquen su identidad mediante un segundo método, como un código enviado a su teléfono móvil o correo electrónico, además de su contraseña, antes de acceder a su cuenta. Esto ayuda a prevenir el acceso no autorizado incluso si la contraseña se ve comprometida.</li>
                        </ul>
                    </section>
                    <section className='mt-3'>
                        ...
                        <p>
                        En el caso específico de la información bancaria, esta solo se compartirá cuando usted contrate un servicio o realice una compra a través de nuestro sitio web. Toda la información bancaria se tratará de manera confidencial y se transferirá utilizando medidas de seguridad adecuadas para evitar la extracción por parte de terceros.
                        </p>
                    </section>
                    <section className='mt-3'>
                        ...
                        <ul>
                            <li>Para el cumplimiento legal y regulaciones</li>
                            <li>Para la mejora de la experiencia del usuario</li>
                            <li>Para la seguridad y prevención de fraudes</li>
                        </ul>
